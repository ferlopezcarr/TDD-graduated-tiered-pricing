...
import "mocha";
import { SubscriptionService } from "../../../main/features/subscription/services/susbscription.service";
import { SubscriptionMessages } from "../../../main/features/subscription/utils/subscription-messages";
...
describe("Subscription Service Unit Tests", () => {
  ...
  it("calculateTotalPriceFromSubscriptions when no subscription should return subscriptions invalid error", () => {
    ...
    assert.throws(
      ...
      Error,
      SubscriptionMessages.error.subscriptionNumber.invalid
    );
  });
});
